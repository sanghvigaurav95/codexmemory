...
7. Once it gets the results , you can even ask how many tokens did we save using this tool ? Ai should respond with the exact count something like this -- By using the Codex Resonance Search (resonance_search) tool, we saved a significant amount of context tokens! Here is a rough breakdown of the savings:
